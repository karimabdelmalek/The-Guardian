...
public class BusinessFragment extends Fragment implements CommonView
{
    ...
    public void FetchData ()
    {
        if (Utilities.CheckIfApplicationIsConnected(getActivity())) {
            Task<ParentResponse> returnedDataTask = WebServices.getBusinessItems(getActivity().getApplicationContext());
