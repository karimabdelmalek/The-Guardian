...
public class SportsFragment extends Fragment implements CommonView {
    ...
    public void FetchData() {
        if (Utilities.CheckIfApplicationIsConnected(getActivity())) {
            Task<ParentResponse> returnedDataTask = WebServices.getSportsItems(getActivity().getApplicationContext());
