...
public class TravelFragment extends Fragment implements CommonView {
    ...
    public void FetchData() {
        if (Utilities.CheckIfApplicationIsConnected(getActivity())) {
            Task<ParentResponse> returnedDataTask = WebServices.getTravelItems(getActivity().getApplicationContext());
