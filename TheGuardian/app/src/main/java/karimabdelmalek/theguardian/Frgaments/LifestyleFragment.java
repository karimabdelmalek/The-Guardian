...
public class LifestyleFragment extends Fragment implements CommonView {
    ...
    public void FetchData() {
        if (Utilities.CheckIfApplicationIsConnected(getActivity())) {
            Task<ParentResponse> returnedDataTask = WebServices.getLifeStyleItems(getActivity().getApplicationContext());
