...
public class FashionFragment extends Fragment implements CommonView
{
    ...
    public void FetchData ()
    {
        if (Utilities.CheckIfApplicationIsConnected(getActivity())) {
            Task<ParentResponse> returnedDataTask = WebServices.getFashionItems(getActivity().getApplicationContext());
