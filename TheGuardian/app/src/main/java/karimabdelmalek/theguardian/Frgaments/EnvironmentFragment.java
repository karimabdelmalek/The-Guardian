...
public class EnvironmentFragment extends Fragment implements CommonView
{
    ...
    public static EnvironmentFragment newInstance(int sectionNumber) {
    ...
    public void FetchData ()
    {
        if (Utilities.CheckIfApplicationIsConnected(getActivity())) {
            Task<ParentResponse> returnedDataTask = WebServices.getEnvironmentItems(getActivity().getApplicationContext());
