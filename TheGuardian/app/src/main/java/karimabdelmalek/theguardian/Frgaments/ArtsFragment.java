...
public class ArtsFragment extends Fragment implements CommonView {
    ...
    public static ArtsFragment newInstance(int sectionNumber) {
    ...
    public void FetchData() {
        if (Utilities.CheckIfApplicationIsConnected(getActivity())) {
            Task<ParentResponse> returnedDataTask= WebServices.getArtsItems(getActivity().getApplicationContext());
