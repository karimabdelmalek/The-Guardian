...
import karimabdelmalek.theguardian.Frgaments.ArtsFragment;
import karimabdelmalek.theguardian.Frgaments.BusinessFragment;
import karimabdelmalek.theguardian.Frgaments.EnvironmentFragment;
import karimabdelmalek.theguardian.Frgaments.FashionFragment;
import karimabdelmalek.theguardian.Frgaments.HomeFragment;
import karimabdelmalek.theguardian.Frgaments.LifestyleFragment;
import karimabdelmalek.theguardian.Frgaments.SportsFragment;
import karimabdelmalek.theguardian.Frgaments.TechnogyFragment;
import karimabdelmalek.theguardian.Frgaments.TravelFragment;
import karimabdelmalek.theguardian.Presenters.MainPresenter;
import karimabdelmalek.theguardian.Presenters.MainPresenterImplementation;
import karimabdelmalek.theguardian.Presenters.MainView;
...
public class ActivityMain extends AppCompatActivity implements MainView {
    ...
    public void setSelectedItemOnNavigationDrawer(int identifier) {
        drawer.closeDrawers();
        if (identifier == R.id.home_item && selectedFragmentTitle != "Home") // also checking if it's not already selected
        {
